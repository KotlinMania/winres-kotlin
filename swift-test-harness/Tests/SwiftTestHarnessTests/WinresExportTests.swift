...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Winres.swiftmodule/`
...
//      `import Winres` above would fail at compile time.
//
//   2. The static archive `libWinres.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Winres" }` and
//      `flattenPackage = "io.github.kotlinmania.winres"` configuration in
...
final class WinresExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Winres swift module imported cleanly")
    }
}
