...
kotlin {
    ...
    val xcf = XCFramework("Winres")

    macosArm64 {
        binaries.framework { baseName = "Winres"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Winres"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Winres"
        flattenPackage = "io.github.kotlinmania.winres"
    }

    android {
        namespace = "io.github.kotlinmania.winres"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "winres-kotlin", version.toString())

    pom {
        name.set("winres-kotlin")
        description.set("Kotlin Multiplatform port of mxre/winres - Create and set windows icons and metadata for executables")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/winres-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/winres-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/winres-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/winres-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleWinresXCFramework",
    "assembleWinresDebugXCFramework",
    "assembleWinresReleaseXCFramework",
    "assembleDebugIosFatFrameworkForWinresXCFramework",
    "assembleReleaseIosFatFrameworkForWinresXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForWinresXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForWinresXCFramework",
    "assembleDebugMacosFatFrameworkForWinresXCFramework",
    "assembleReleaseMacosFatFrameworkForWinresXCFramework",
    "assembleDebugTvosFatFrameworkForWinresXCFramework",
    "assembleReleaseTvosFatFrameworkForWinresXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForWinresXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForWinresXCFramework",
    "assembleDebugWatchosFatFrameworkForWinresXCFramework",
    "assembleReleaseWatchosFatFrameworkForWinresXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForWinresXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForWinresXCFramework",
