...
public class WindowsResource {
    ...
    private val versionInfo: MutableMap<VersionInfo, ULong> = linkedMapOf(
    ...
    public fun writeResourceText(): String = buildString {
...
internal fun escapeResourceString(string: String): String = buildString {
