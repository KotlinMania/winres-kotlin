...
This file is the quick-reference operating contract for winres-kotlin. The longer
...
winres-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`winres`](https://crates.io/crates/winres). Upstream Rust is the behavioral oracle while the
